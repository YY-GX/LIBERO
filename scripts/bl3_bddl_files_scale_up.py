...
# ================ Params ================
seed_ls = [10000, 10001, 10002]
num_diff_combination = 5
...
for seed in seed_ls:
    ...
    for i, bddl_file in enumerate(bddl_files):
        ...
        while cnt < 5:
            if dead_loop_cnt > 10000:
                print(f"[ERROR] Dead loop for bddl file: {bddl_file}; Only {cnt} combinations obtained :(")

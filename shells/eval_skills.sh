...
for i in {0..9}; do
    sbatch_command+="python lifelong/evaluate.py --run_id 2 --task_id $i --load_task $i --seed 10000  --device_id 0 --benchmark \\\"libero_90\\\" --policy \\\"bc_transformer_policy\\\" --algo \\\"base\\\" --version \\\"train_base_90_v0\\\" --save-videos && \
"
done

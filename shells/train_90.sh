...
sbatch --gpus 1 --cpus-per-task=8 \
       ...
       "
#export CUDA_VISIBLE_DEVICES=7 && export MUJOCO_EGL_DEVICE_ID=7 && python lifelong/train_skills.py is_split=false is_customize_task=false version="train_base_90_v0" benchmark_name=libero_90 policy=bc_transformer_policy lifelong=base

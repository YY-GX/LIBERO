...
if __name__ == '__main__':
    ...
    scene_name = "shelf_table_scene"
    language = "Moving popcorn from table to topside of wooden shelf and then moving chocolate pudding from table to topside of wooden shelf"
    create_task(scene_name=scene_name,
                language=language,
                objects_of_interest=[f"popcorn_1", f"chocolate_pudding_1"],
                goal_states=[
                    ("On", f"popcorn_1", f"wooden_shelf_1_top_side"),
                    ("On", f"chocolate_pudding_1", f"wooden_shelf_1_top_side")
                ]
    )

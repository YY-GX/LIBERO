...
def parse_args():
    ...
    parser.add_argument(
        ...
        choices=["libero_10", "libero_90", "libero_spatial", "libero_object", "libero_goal", "yy_try",
                 "modified_libero", "single_step", "ablation_1"],
...
def main():
    ...
    for task_idx, task_id in enumerate(task_id_ls):  # task_id is the actual id of the task. task_idx is just the index.
        ...
        with Timer() as t:
            ...
            with open(os.path.join(args.model_path_folder, f"eval_tasks_on_modified_envs_benchmark_{args.benchmark}_seed{args.seed}", f"succ_list_evaluation_on_modified_envs.npy"), 'wb') as f:
